...
```
Error: locator.click: Error: strict mode violation: locator('//button[contains(text(),\'Alert\')]') resolved to 2 elements:
    1) <button data-target="alert-tab" class="tab px-4 py-2 text-blue-500 hover:bg-blue-200 focus:outline-none active">Alert</button> aka getByRole('button', { name: 'Alert', exact: true })
    2) <button onclick="showAlert()" class="bg-blue-500 text-white px-4 py-2 rounded">Show Alert</button> aka getByRole('button', { name: 'Show Alert' })

Call log:
  - waiting for locator('//button[contains(text(),\'Alert\')]')
        ...
        - insertion [ref=e68]:
          - generic [ref=e71]:
            ...
            - link "Computers & Electronics" [ref=e74] [cursor=pointer]:
              ...
              - img [ref=e77]
            - link "Input Devices" [ref=e79] [cursor=pointer]:
              - generic "Input Devices" [ref=e80]
              - img [ref=e82]
            - link "Technical Reference" [ref=e84] [cursor=pointer]:
              - generic "Technical Reference" [ref=e85]
              - img [ref=e87]

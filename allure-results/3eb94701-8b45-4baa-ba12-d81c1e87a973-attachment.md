...
```
Error: locator.press: Unknown key: "i am enetering a message"
Call log:
  - waiting for locator('//input[@id=\'user-message\']')
    - locator resolved to <input type="text" id="user-message" placeholder="Please enter your Message" class="border border-gray-550 w-full h-35 rounded px-10"/>
  - elementHandle.press("i am enetering a message")
...
> 20 |        await page1.locator("//input[@id='user-message']").press("i am enetering a message");
     |                                                           ^ Error: locator.press: Unknown key: "i am enetering a message"
  21 |        await page1.waitForTimeout(3000); // Waits for 3 seconds   
  22 |        await page1.locator("//button[@id='showInput']").click();
  23 |        
  24 | 
  25 |        await expect(page1.locator("//p[@id='message']")).toContainText("i am enetering a message");
  26 | 
  27 | 
  28 | 
  29 | 

...
```ts
  ...
  16 |     
  17 | 
  18 |        await page1.locator("//input[@id='user-message']").fill(" i am enetering a message ");
> 19 |        const values = await page1.locator('//*[@id="user-message"]').getAttribute('placeholder');
     |                                                                      ^ Error: locator.getAttribute: Error: strict mode violation: locator('//*[@id="user-message"]') resolved to 3 elements:

...
- Name: AutomationWebsite\test\Handlingalerts.spec.ts >> Prompt Alert
- Location: AutomationWebsite\test\Handlingalerts.spec.ts:37:5
...
Call log:
  - waiting for getByRole('button', { name: 'Prompt Alert' })
        ...
        - insertion [ref=e68]:
          - generic [ref=e71]:
            ...
            - link "Web Apps & Online Tools" [ref=e79] [cursor=pointer]:
              ...
              - img [ref=e82]
            - link "Dictionaries & Encyclopedias" [ref=e84] [cursor=pointer]:
              - generic "Dictionaries & Encyclopedias" [ref=e85]
              - img [ref=e87]
...
> 48 |        console.log(dialog.type())
  ...
  50 | 
  51 |     })
  52 |     await page.locator("//button[text()='Prompt Alert']").scrollIntoViewIfNeeded();   

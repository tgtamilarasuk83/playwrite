...
- Location: AutomationWebsite\test\Handlingalerts.spec.ts:18:5
...
Call log:
  - waiting for getByRole('button', { name: 'Confirmation Alert' })
      ...
      - generic [ref=e66]:
        - insertion [ref=e68]:
          - generic [ref=e71]:
            ...
            - link "Java (Programming Language)" [ref=e74] [cursor=pointer]:
              - generic "Java (Programming Language)" [ref=e75]
              - img [ref=e77]
            - link "Word Processing Software" [ref=e79] [cursor=pointer]:
              - generic "Word Processing Software" [ref=e80]
              - img [ref=e82]

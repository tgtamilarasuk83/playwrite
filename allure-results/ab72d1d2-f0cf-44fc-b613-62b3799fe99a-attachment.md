...
Call log:
  ...
  - waiting for locator('//*[@id="confirm-demo"]')
    13 × locator resolved to <p class="mt-20" id="confirm-demo"></p>
       - unexpected value ""
...
```ts
  ...
  5  |    
  6  |     // simple alert 
  7  |     page.once('dialog', async(alert) =>{    
  8  |         console.log(alert.message())
  9  |         await alert.accept();     
  10 |     })
  11 |     await page.locator("//button[@type='button']").nth(0).click() 
  12 | 
  13 |     await page.locator('//*[@id="__next"]/div/main/section[2]/div/div/div/div[2]/div/p[1]/button').click();
  14 |     // accept allert 
  15 |     page.once('dialog', async(alert)=>{
  16 |         console.log(alert.message())
  17 |         alert.type()
  18 |         alert.accept()
  19 |     })
  20 | 
> 21 |     await expect( page.locator('//*[@id="confirm-demo"]')).toContainText("You pressed OK!");
     |                                                            ^ Error: expect(locator).toContainText(expected) failed
  22 | 
  23 | 
  24 |     await page.locator('//*[@id="__next"]/div/main/section[2]/div/div/div/div[2]/div/p[1]/button').click();
  25 |     page.once('dialog', async(alert)=>{
  26 |          alert.type()
  27 |         console.log(alert.message())
  28 |         alert.dismiss()
  29 |     })
  30 | 
  31 |       await expect( page.locator('//*[@id="confirm-demo"]')).toContainText("You pressed Cancel!");
  32 | 
  33 | 
  34 | 
  35 | 

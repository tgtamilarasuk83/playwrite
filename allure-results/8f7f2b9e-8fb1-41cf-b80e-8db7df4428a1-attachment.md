...
- textbox "Email Address": hwfwirjwudeff@gmail.com
...
```ts
  ...
  23 |        await page1.locator('[data-qa="signup-email"]').fill("hwfwirjwudeff@gmail.com");
  ...
  58 |          await login.locator("[data-qa='login-email']").fill("hwfwirjwudeff@gmail.com");

...
```ts
  ...
  83 |     })
  84 | 
> 85 |     await expect( page.locator("//p[@id='confirm-demo']")).toContainText("You pressed OK!");
     |                                                            ^ Error: expect(locator).toContainText(expected) failed
  86 | 
  87 | 
  ...
  92 |     })
  93 | 
  94 |       await expect( page.locator("//p[@id='confirm-demo']")).toContainText("You pressed Cancel!");
  95 | 
  96 | 
  97 | 
  98 | 

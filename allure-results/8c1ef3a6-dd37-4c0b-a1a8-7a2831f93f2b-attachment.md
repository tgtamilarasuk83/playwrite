      ...
      - generic [ref=e66]:
        - insertion [ref=e68]:
          - generic [ref=e71]:
            ...
            - link "Network Security" [ref=e74] [cursor=pointer]:
              - generic "Network Security" [ref=e75]
              - img [ref=e77]
            - link "Dictionaries & Encyclopedias" [ref=e79] [cursor=pointer]:
              - generic "Dictionaries & Encyclopedias" [ref=e80]
              - img [ref=e82]
...
```ts
  ...
  12 | 
  13 |     })
  14 |     await page.locator("//button[@class='tab px-4 py-2 text-blue-500 hover:bg-blue-200 focus:outline-none active']").click()

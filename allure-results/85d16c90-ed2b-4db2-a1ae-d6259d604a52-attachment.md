...
- Name: AutomationWebsite\test\Utestmui.spec.ts >> AI
- Location: AutomationWebsite\test\Utestmui.spec.ts:37:5
...
```ts
  ...
  35 |   
  36 | 
  37 | test("AI", async ({ page }) => {
  38 | 
  39 |     await page.goto("https://www.testmuai.com/selenium-playground/simple-form-demo/");
  40 | 
  41 |     const sum1 = page.locator("//input[@id='sum1']");
  42 |     const sum2 = page.locator("//input[@id='sum2']");
  43 | 
  44 |     await sum1.fill("20");
  45 |     await sum2.fill("20");
  46 | 
  47 |     await page.locator("//button[normalize-space()='Get Sum']").click();
  48 | 
  49 |     await expect(page.locator("//p[@id='addmessage']"))
> 50 |         .toHaveText("40");
     |          ^ Error: expect(locator).toHaveText(expected) failed
  51 | });
  52 | 

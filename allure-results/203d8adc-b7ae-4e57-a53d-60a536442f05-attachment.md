        ...
        - generic [ref=e50]:
          ...
          - generic [ref=e53]:
            - generic [ref=e54]:
              ...
              - textbox "Please enter your Message" [active] [ref=e56]: i am enetering a message
...
```ts
  ...
  10 | 
  11 |        await page1.goto("https://www.testmuai.com/selenium-playground/simple-form-demo/")
  12 |        console.log(page1.title())
  13 |        console.log(page1.url());
  14 |     
  15 | 
  16 |        await page1.locator("//input[@id='user-message']").fill(" i am enetering a message ");
> 17 |        const values = await page1.locator('//*[@id="user-message"]').getAttribute('placeholder');
     |                                                                      ^ Error: locator.getAttribute: Error: strict mode violation: locator('//*[@id="user-message"]') resolved to 3 elements:
  18 |        console.log(values);
  19 |        await page1.locator("//button[@id='showInput']").click();
  20 | 
  21 | 
  22 | 
  23 | 

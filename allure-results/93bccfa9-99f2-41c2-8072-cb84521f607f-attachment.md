...
```
Error: locator.scrollIntoViewIfNeeded: Unexpected token "/" while parsing css selector "/html/body/div[2]/main/div/div[1]/button[3]". Did you mean to CSS.escape it?
Call log:
  - waiting for /html/body/div[2]/main/div/div[1]/button[3]
      ...
      - generic [ref=e66]:
        - insertion [ref=e68]:
          - generic [ref=e71]:
            ...
            - link "Software Utilities" [ref=e74] [cursor=pointer]:
              - generic "Software Utilities" [ref=e75]
              - img [ref=e77]
            - link "Data" [ref=e79] [cursor=pointer]:
              - generic "Data" [ref=e80]
              - img [ref=e82]
